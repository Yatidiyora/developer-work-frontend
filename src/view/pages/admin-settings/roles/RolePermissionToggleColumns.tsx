...
import { TogglerType } from '../../../../common/types/interface/RoleModal.interface';

const RolePermissionToggleColumns = ({
  setToggler,
}: {
  setToggler: React.Dispatch<React.SetStateAction<TogglerType>>;
}) => {
      ...
      setToggler((prevState) => ({
        ...
        assignedPermissions: {
          ...
          [id]: {
            ...
            view:
              type === TOGGER_PERMISSION_TYPE.VIEW
                ? value
                : prevState.assignedPermissions[id]?.view || false,
            edit:
              type === TOGGER_PERMISSION_TYPE.EDIT
                ? value
                : prevState.assignedPermissions[id]?.edit || false,
            delete:
              type === TOGGER_PERMISSION_TYPE.DELETE
                ? value
                : prevState.assignedPermissions[id]?.delete || false,
          },
        },
      }));
    }
